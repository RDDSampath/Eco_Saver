    ...
    return(
        <div className='home'>
            ...
            <div className="T-home">
                ...
                <div className="box-H">
                    <div className="box-1">
                        <img src={images.Gc}  alt='image' className='h-image'/>
                    ...
                    <div className="box-1">
                        <img src={images.Bin}  alt='image' className='h-image'/>
                    ...
                    <div className="box-1">
                        <img src={images.Rc}  alt='image' className='h-image'/>
                    ...
                    <div className="box-1">
                        <img src={images.Pc}  alt='image' className='h-image'/>
