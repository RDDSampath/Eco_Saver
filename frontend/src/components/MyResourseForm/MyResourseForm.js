    ...
    <form  className='frm '>
     <div className='letters'>        
      <div className='title' style={{ width: '100%' }}>
        <label htmlFor="title" className='in'>Title:</label><br/>
        <input type="text" name="title"id="title" style={{ width: '100%' }}/>
      </div>
      <div className='category'style={{ width: '100%' }}>
        <label htmlFor="category" className='in'>Category:</label><br/>
      ...
      <div className='file'style={{ width: '100%' }}>
        <label htmlFor="file" className='in'>File:</label><br/>
        <input type="file" name="file" id="file" style={{ width: '100%' }}/>
      </div>

      <div className='tags'style={{ width: '100%' }}>
        <label htmlFor="tags" className='in'>Tags:</label><br/>
        <input type="text" name="tags" id="tags" style={{ width: '100%' }}/>
      </div>
      <div className='description'style={{ width: '100%' }}>
        <label htmlFor="description" className='in'>Description:</label><br/>
